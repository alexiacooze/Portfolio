      ...
      <div className="flash__title-container">
        ...
        <div className="flash__demo-container">
          ...
          <a
            ...
            href="https://flash-client.herokuapp.com/home" target="_blank" rel="noreferrer"
          >
        ...
        <p className='flash__description'>This project is an online study tool that has FREE pre-generated flashcard-style questions to aid in learning the core concepts of front-end development.</p>
        <p className="flash__install">Installation and Code:</p>
        <p className="flash__install-description">The repositories/ code can be found within github. If you are
            ...
            downloading the codebase, running the front end browser,
            and backend server from your own computer.</p>
        {/* <img alt='github'>
